...
when ODIN_OS == .Windows do foreign import freetype "freetype291.lib"
when ODIN_OS == .Darwin do foreign import freetype "macos/libfreetype.a"
when ODIN_OS == .Linux do foreign import freetype "external/libfreetype.a"
...
Face_Init_Func :: #type proc "c" (
	stream: Stream,
	face: Face,
	typeface_index, num_params: c.int,
